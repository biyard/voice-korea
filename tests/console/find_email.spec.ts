...
test.describe('Find Email Page Flow', () => {
    test('[FindEmail-001] Successful Email Retrieval', async ({ page }) => {
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/01-find-email-page.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/02-name-filled.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/03-cellphone-filled.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/04-auth-requested.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/05-auth-filled.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/06-find-email-clicked.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-001/07-success.png', fullPage: true });
    });

    test('[FindEmail-002] Validate Empty Field Errors', async ({ page }) => {
        await page.goto('https://voice-korea.dev.biyard.co/en/find-email');
        await page.screenshot({ path: 'screenshots/console/FindEmail-002/01-find-email-page.png', fullPage: true });
        ...
        await page.screenshot({ path: 'screenshots/console/FindEmail-002/02-validation-errors.png', fullPage: true });
    });
});
