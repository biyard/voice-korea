...
test.describe("UI Mobile Responsiveness & Individual Project Page Tests", () => {
  test("[Project-ID-002] Confirm it has project details", async ({
    page,
  }, testInfo) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ).cookies;
    ...
    await page.context().addCookies(cookies);
    await page.goto(
      `https://dev.voice-korea.com/en/projects/${randomProjectNumber}`,
    );
    await page.context().addCookies(cookies);
    ...
    const projectImage = page.getByRole("img", {
      name: "Header Section Image",
    });
    await expect(projectImage).toBeVisible();
    await page.screenshot({
      path: `${screenshotBase}/02-project-image.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `${screenshotBase}/03-project-participants.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `${screenshotBase}/04-project-input.png`,
    });
  });
  ...
  test("[Project-ID-003] Confirm All Tabs Exist", async ({ page }) => {
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-003/01-page-entered.png`,
      fullPage: true,
    });
    ...
    const sampleSurvey = page
      .getByRole("paragraph")
      .filter({ hasText: "Sample Survey" });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-003/02-project-tabs.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-004] Test Forms And Their Labels, Section-01", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-004/01-page-entered.png`,
      fullPage: true,
    });

    const sectionOne = page
      .getByRole("paragraph")
      .filter({ hasText: "Basic Info" });
    await expect(sectionOne).toBeVisible();
    await sectionOne.click();
    await page.screenshot({
      path: `screenshots/users/project-id-004/02-basic-info.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-004/03-pdf-material.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-005] Test Forms And Their Labels, Section-02", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-005/01-page-entered.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-005/02-sample-survey.png`,
      fullPage: true,
    });

    const sampleSurveyHeader = page
      .locator("#sample-survey")
      .getByText("Sample Survey", { exact: true });
    await expect(sampleSurveyHeader).toBeVisible();

    const sampleSurveyDescription = page
      .locator("div")
      .filter({ hasText: /^Sample Survey Title$/ })
      .nth(3);
    ...
    const surveyInputOne = page
      .getByRole("textbox", { name: "Please Enter Details" })
      .first();
    await expect(surveyInputOne).toBeVisible();
    await surveyInputOne.click();
    await surveyInputOne.fill("Test input 1");
    await page.screenshot({
      path: `screenshots/users/project-id-005/03-survey-input.png`,
      fullPage: true,
    });

    const surveyInputTwo = page
      .getByRole("textbox", { name: "Please Enter Details" })
      .nth(1);
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-005/04-survey-input.png`,
      fullPage: true,
    });
    ...
    const surveyCheckBoxTwo = page
      .locator("div:nth-child(2) > label > .w-\\[24px\\]")
      .first();
    await expect(surveyCheckBoxTwo).toBeVisible();
    await surveyCheckBoxTwo.click();

    const surveyCheckBoxThree = page
      .locator(
        "div:nth-child(5) > div:nth-child(3) > div > label > .w-\\[24px\\]",
      )
      .first();
    await expect(surveyCheckBoxThree).toBeVisible();
    await surveyCheckBoxThree.click();

    const surveyCheckBoxFour = page.locator(
      "div:nth-child(5) > div:nth-child(3) > div:nth-child(2) > label > .w-\\[24px\\]",
    );
    await expect(surveyCheckBoxFour).toBeVisible();
    await surveyCheckBoxFour.click();
    await page.screenshot({
      path: `screenshots/users/project-id-005/05-survey-checkbox.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-005/06-survey-submit.png`,
      fullPage: true,
    });
  });
  ...
  test("[Project-ID-006] Validations, Section-02", async ({ page }) => {
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-006/01-page-entered.png`,
      fullPage: true,
    });
    ...
    await sampleSurvey.click();
    await page.screenshot({
      path: `screenshots/users/project-id-006/02-sample-survey.png`,
      fullPage: true,
    });
    ...
    await submitButton.click();
    await page.screenshot({
      path: `screenshots/users/project-id-006/03-survey-submit.png`,
      fullPage: true,
    });

    const checkBoxErrorMessage = page.getByText(
      "Please select at least one option",
    );
    await expect(checkBoxErrorMessage).toBeVisible();
    await page.screenshot({
      path: `screenshots/users/project-id-006/04-survey-checkbox-error.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-006/05-survey-input-error.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-007] Test Forms And Their Labels, Section-03", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-007/01-page-entered.png`,
      fullPage: true,
    });

    const deliberation = page
      .getByRole("paragraph")
      .filter({ hasText: "Deliberation" });
    await expect(deliberation).toBeVisible();
    await deliberation.click();
    await page.screenshot({
      path: `screenshots/users/project-id-007/02-deliberation.png`,
      fullPage: true,
    });

    const deliberationHeader = page
      .locator("#deliberation")
      .getByText("Deliberation");
    await expect(deliberationHeader).toBeVisible();

    const deliberationDescription = page
      .locator("div")
      .filter({ hasText: /^Deliberation Title$/ })
      .nth(3);
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-007/03-deliberation-materials.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-008] Test Forms And Their Labels, Section-04", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-008/01-page-entered.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-008/02-discussion.png`,
      fullPage: true,
    });

    const discussionHeader = page
      .locator("#discussion")
      .getByText("Discussion", { exact: true });
    await expect(discussionHeader).toBeVisible();

    const firstDiscussionTab = page
      .locator("div")
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-008/03-discussion-highlights.png`,
      fullPage: true,
    });

    const secondDiscussionTab = page
      .locator("div")
      .filter({ hasText: /^Video Discussion$/ })
      .nth(2);
    await expect(secondDiscussionTab).toBeVisible();
    await secondDiscussionTab.click();
    await page.screenshot({
      path: `screenshots/users/project-id-008/04-discussion-video.png`,
      fullPage: true,
    });
    ...
    await expect(relatedMaterials).toBeVisible();
    await page.screenshot({
      path: `screenshots/users/project-id-008/05-discussion-materials.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-009] Test Forms And Their Labels, Section-05", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-009/01-page-entered.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/02-final-survey.png`,
      fullPage: true,
    });

    const finalSurveyHeader = page.getByText(
      "Final Survey4월 5일 2025년 ~ 4월",
    );
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/03-final-survey-button.png`,
      fullPage: true,
    });

    const finalSurveyInput = page
      .getByRole("textbox", { name: "Please Enter Details" })
      .first();
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/04-final-survey-input.png`,
      fullPage: true,
    });

    const secondFinalSurveyInput = page
      .getByRole("textbox", { name: "Please Enter Details" })
      .nth(1);
    ...
    const finalSurveyCheckBoxFour = page.locator(
      "div:nth-child(5) > div:nth-child(3) > div:nth-child(2) > label > .w-\\[24px\\]",
    );
    await expect(finalSurveyCheckBoxFour).toBeVisible();
    await finalSurveyCheckBoxFour.click();
    await page.screenshot({
      path: `screenshots/users/project-id-009/05-final-survey-checkbox.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/06-final-survey-submit.png`,
      fullPage: true,
    });

    const finalSurveyPopup = page
      .locator("div")
      .filter({
        hasText:
          "Please check again before voting.Voting is anonymous and once a vote is",
      })
      .nth(2);
    await expect(finalSurveyPopup).toBeVisible();
    await page.screenshot({
      path: `screenshots/users/project-id-009/07-final-survey-popup.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/08-final-survey-cancel.png`,
      fullPage: true,
    });

    await finalSurveySubmitButton.click();
    await page.screenshot({
      path: `screenshots/users/project-id-009/09-final-survey-submit-again.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/users/project-id-009/10-final-survey-confirm.png`,
      fullPage: true,
    });
  });
  ...
  test("[Project-ID-010] Validations, Section-05", async ({ page }) => {
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-010/01-page-entered.png`,
      fullPage: true,
    });
    ...
    await finalSurvey.click();
    await page.screenshot({
      path: `screenshots/users/project-id-010/02-final-survey.png`,
      fullPage: true,
    });

    const finalSurveyHeader = page
      .locator("#sample-survey")
      .getByText("Sample Survey", { exact: true });
    await expect(finalSurveyHeader).toBeVisible();
    ...
    await finalSurveyButton.click();
    await page.screenshot({
      path: `screenshots/users/project-id-010/03-final-survey-button.png`,
      fullPage: true,
    });
    ...
    await submitButton.click();
    await page.screenshot({
      path: `screenshots/users/project-id-010/04-final-survey-submit.png`,
      fullPage: true,
    });
    ...
    await expect(checkBoxErrorMessage).toBeVisible();
    await page.screenshot({
      path: `screenshots/users/project-id-010/05-final-survey-checkbox-error.png`,
      fullPage: true,
    });
    ...
    await expect(inputErrorMessage).toBeVisible();
    await page.screenshot({
      path: `screenshots/users/project-id-010/06-final-survey-input-error.png`,
      fullPage: true,
    });
  });

  test("[Project-ID-011] Test Forms And Their Labels, Section-06", async ({
    page,
  }) => {
    const cookies = JSON.parse(
      fs.readFileSync("storage/auth.json", "utf8"),
    ...
    await page.context().addCookies(cookies);
    await page.screenshot({
      path: `screenshots/users/project-id-011/01-page-entered.png`,
      fullPage: true,
    });

    const finalDraft = page
      .getByRole("paragraph")
      .filter({ hasText: "Final Draft" });
    await expect(finalDraft).toBeVisible();
    await finalDraft.click();

    const finalDraftHeader = page
      .locator("#final-draft")
      .getByText("Final Draft");
    await expect(finalDraftHeader).toBeVisible();

    const finalDraftTab = page.locator(
      "#final-draft > div:nth-child(2) > div > div > .w-full",
    );
    await expect(finalDraftTab).toBeVisible();

    await page.screenshot({
      path: `screenshots/users/project-id-011/02-final-draft.png`,
      fullPage: true,
    });
  });
});
